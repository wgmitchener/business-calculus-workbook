...
Go back to \cref{sec:gr-with-fp} (page \pageref{sec:gr-with-fp}) and recall what you found about that function:
\begin{ProblemSet}[pencil space=1in]
 ...
 \end{Problem}
 \begin{Problem}
  $f$ is increasing on what intervals:
 \end{Problem}
 \begin{Problem}
  $f$ is decreasing on what intervals:
 \end{Problem}
 \begin{Problem}
  $f$ has a local minimum at this point:
 \end{Problem}
 \begin{Problem}
...
Now we'll practice graphing $f$ with the second derivative information as well.
