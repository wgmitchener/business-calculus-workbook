\Section{Business modeling---marginal analysis \Star}
\label{sec:biz-mod-marginal}

Recall that in a business scenario, \emph{marginal \Quantity} is the derivative of \emph{\Quantity} with respect to the number of units of the product that are produced and sold.
