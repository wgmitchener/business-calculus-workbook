...
\begin{multicols}{2}
 \begin{ProblemSet}[pencil space=1.5in]
  \EqProb{z = 4 \cdot (-5 x^2)}
  \EqProb{z = 4 \cdot (-5 x)^2}
  \EqProb{z = \frac{-5x^2}{3}}
  \EqProb{z = \frac{(-5 x)^2}{3}}
  \EqProb{z = \pfrac{-5 x}{3}^2}
  \EqProb{z = \frac{3}{5x^2}}
  \EqProb{z = \frac{3}{(5x)^2}}
  \EqProb{z = \pfrac{3}{5 x}^2}
 \end{ProblemSet}
\end{multicols}
...
\begin{multicols}{2}
 \begin{ProblemSet}[pencil space=2in]
  ...
  \EqProb{z = \pfrac{x^2 \cdot y^{-3}}{y^5 \cdot x^3}^2}
